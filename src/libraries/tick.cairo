...
trait ITick<TState> {
    ...
    fn cross(
        ref self: TState, tick: i32, fee_growth_global_0_X128: u256, fee_growth_global_1_X128: u256
    ) -> i128;
}
...
mod TickComponent {
    ...
    > of super::ITick<ComponentState<TContractState>> {
        ...
        fn get_fee_growth_inside(
            ...
            let (fee_growth_below_0_X128, fee_growth_below_1_X128) =
            ...
            let (fee_growth_above_0_X128, fee_growth_above_1_X128) =
