...
trait IPoolSwapTest<TContractState> {
    ...
    fn swap_to_lower_sqrt_price(
        ref self: TContractState,
        pool: ContractAddress,
        sqrt_price_X96: u256,
        recipient: ContractAddress
    );
    fn swap_to_higher_sqrt_price(
        ref self: TContractState,
        pool: ContractAddress,
        sqrt_price_X96: u256,
        recipient: ContractAddress
    );
    fn swap_for_exact_0_multi(
        ref self: TContractState,
        recipient: ContractAddress,
        pool_input: ContractAddress,
        pool_output: ContractAddress,
        amount0_out: u256
    );
    fn swap_for_exact_1_multi(
        ref self: TContractState,
        recipient: ContractAddress,
        pool_input: ContractAddress,
        pool_output: ContractAddress,
    ...
    impl PoolSwapTest of super::IPoolSwapTest<ContractState> {
        fn swap_exact_0_for_1(
            ...
            pool_dispatcher
                .swap(
                    recipient,
                    true,
                    IntegerTrait::<i256>::new(amount0_in, false),
        ...
        fn swap_0_for_exact_1(
            ...
            pool_dispatcher
                .swap(
                    recipient,
                    true,
                    IntegerTrait::<i256>::new(amount1_out, true),
                    sqrt_price_limit_X96,
                    callback_data
                );
        }
        ...
        fn swap_exact_1_for_0(
            ...
            pool_dispatcher
                .swap(
                    recipient,
                    false,
                    IntegerTrait::<i256>::new(amount1_in, false),
                    sqrt_price_limit_X96,
                    callback_data
                );
        }
        ...
        fn swap_1_for_exact_0(
            ...
            pool_dispatcher
                .swap(
                    recipient,
                    false,
                    IntegerTrait::<i256>::new(amount0_out, true),
                    sqrt_price_limit_X96,
                    callback_data
                );
        }
        ...
        fn swap_to_lower_sqrt_price(
            ...
            pool_dispatcher
                .swap(
                    recipient,
                    true,
                    IntegerTrait::<i256>::new(BoundedInt::max() / 2 - 1, false),
                    sqrt_price_X96,
                    callback_data
                );
        }
        ...
        fn jediswap_v2_swap_callback(
            ...
            if (callback_data_span.len() == 2) {
                ...
                let (token_to_be_paid, amount_to_be_paid) = if (amount0_delta > IntegerTrait::<
                    i256
                >::new(0, false)) {
                ...
                let second_pool_address = Serde::<
                    ContractAddress
                >::deserialize(ref callback_data_span)
                    .unwrap();
                let second_pool_dispatcher = IJediSwapV2PoolDispatcher {
