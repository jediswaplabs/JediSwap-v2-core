...
trait IPoolMintTest<TContractState> {
    fn mint(ref self: TContractState, pool: ContractAddress, recipient: ContractAddress, tick_lower: i32, tick_upper: i32, amount: u128);
...
mod PoolMintTest {
    ...
    impl PoolMintTest of super::IPoolMintTest<ContractState> {
        fn mint(ref self: ContractState, pool: ContractAddress, recipient: ContractAddress, tick_lower: i32, tick_upper: i32, amount: u128) {
