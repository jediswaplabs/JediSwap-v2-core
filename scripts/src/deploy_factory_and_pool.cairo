...
fn main() {
    ...
    let pool_declare_result = declare('JediSwapV2Pool', Option::Some(max_fee), Option::Some(starting_nonce));
    ...
    let factory_declare_result = declare('JediSwapV2Factory', Option::Some(max_fee), Option::Some(starting_nonce + 1));
    ...
    let factory_deploy_result = deploy(factory_class_hash, factory_constructor_data, Option::Some(salt), true, Option::Some(max_fee), Option::Some(starting_nonce + 2));
    ...
    //     factory_contract_address, 'create_pool', invoke_data, Option::Some(max_fee), Option::Some(starting_nonce + 3)
    // );
