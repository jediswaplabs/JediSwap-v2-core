...
fn main() {
    ...
    let pool_declare_result = declare(
        'JediSwapV2Pool', Option::Some(max_fee), Option::Some(starting_nonce)
    );
    ...
    let factory_declare_result = declare(
        'JediSwapV2Factory', Option::Some(max_fee), Option::Some(starting_nonce + 1)
    );
