...
fn token0_1_2() -> (ContractAddress, ContractAddress, ContractAddress) {
    ...
    if (u256_from_felt252(contract_address_to_felt252(token0_address)) < u256_from_felt252(contract_address_to_felt252(token1_address))) {
        if (u256_from_felt252(contract_address_to_felt252(token1_address)) < u256_from_felt252(contract_address_to_felt252(token2_address))) {
            return (token0_address, token1_address, token2_address);
        } else if (u256_from_felt252(contract_address_to_felt252(token2_address)) < u256_from_felt252(contract_address_to_felt252(token0_address))) { 
            return (token2_address, token0_address, token1_address);
        }
        return (token0_address, token2_address, token1_address);
    } else {
        if (u256_from_felt252(contract_address_to_felt252(token0_address)) < u256_from_felt252(contract_address_to_felt252(token2_address))) {
            return (token1_address, token0_address, token2_address);
        } else if (u256_from_felt252(contract_address_to_felt252(token2_address)) < u256_from_felt252(contract_address_to_felt252(token1_address))) { 
