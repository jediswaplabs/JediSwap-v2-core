...
fn test_get_sqrt_ratio_at_tick_is_valid_max_tick() {
    ...
    assert(get_sqrt_ratio_at_tick(MAX_TICK()) == 1461446703485210103287273052203988822378723970342, 'incorrect ratio at MAX_TICK');
}

#[test]
fn test_get_sqrt_ratio_at_tick_is_valid_max_tick_sub_one() {
    let value = MAX_TICK() - IntegerTrait::<i32>::new(1, false);
    assert(get_sqrt_ratio_at_tick(value) == 1461373636630004318706518188784493106690254656249, 'incorrect ratio at MAX_TICK - 1');
}
...
fn _matches_python_by_one_hundredth_of_a_bip(tick: i32, python_ratio: u256, err_msg: felt252) {
    ...
    let diff = if (sqrt_ratio > python_ratio) { sqrt_ratio - python_ratio } else { python_ratio - sqrt_ratio };
...
fn test_get_sqrt_ratio_at_tick_matches_python_by_one_hundredth_of_a_bip() {
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(50, false), 79426470787362564183332749312, '50');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(50, true), 79030349367926623380336279552, '-50');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(100, false), 79625275426524698543654961152, '100');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(100, true), 78833030112140218996086538240, '-100');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(250, false), 80224679980005204522633789440, '250');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(250, true), 78244023372248473262413053952, '-250');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(500, false), 81233731461782943452224290816, '500');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(500, true), 77272108795590580476229713920, '-500');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(1000, false), 83290069058675764276559347712, '1000');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(1000, true), 75364347830767439984841457664, '-1000');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(2500, false), 89776708723585931833226821632, '2500');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(2500, true), 69919044979843140138347528192, '-2500');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(5000, false), 101729702841315830865122557952, '5000');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(5000, true), 61703726247761524449525891072, '-5000');

    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(10000, false), 130621891405334421671298203648, '10000');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(10000, true), 48055510970271650415741239296, '-10000');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(50000, false), 965075977352955512569221611520, '50000');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(50000, true), 6504256538022775632552787968, '-50000');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(250000, false), 21246587762904151822324099702587392, '250000');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(250000, true), 295440463449208326717440, '-250000');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(500000, false), 5697689776479602583788423076217614237696, '500000');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(500000, true), 1101692437046840448, '-500000');
    
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(887272, false), 1461446703478070281035530027706464741740609798144, '887272');
    _matches_python_by_one_hundredth_of_a_bip(IntegerTrait::<i32>::new(887272, true), 4295128738, '-887272');
}
...
fn test_get_tick_at_sqrt_ratio_is_valid_min_sqrt_ratio_plus_one() {
    ...
    let tick = get_tick_at_sqrt_ratio(input);
    assert(tick == (MIN_TICK() + IntegerTrait::<i32>::new(1, false)), 'incorrect tick at MIN_TICK + 1');
}
...
fn test_get_tick_at_sqrt_ratio_is_valid_ratio_closest_to_max_tick() {
    let input = MAX_SQRT_RATIO - 1;
    let tick = get_tick_at_sqrt_ratio(input);
    assert(tick == MAX_TICK() - IntegerTrait::<i32>::new(1, false), 'incorrect tick MAX_SQRT_RATIO');
}
...
fn test_get_tick_at_sqrt_ratio_is_valid_max_sqrt_ratio_minus_one() {
    ...
    let tick = get_tick_at_sqrt_ratio(input);
    assert(tick == MAX_TICK() - IntegerTrait::<i32>::new(1, false), 'incorrect tick at MAX_TICK - 1');
}
...
fn test_get_tick_at_sqrt_ratio_matches_python_within_1() { // TODO Could not reach the end of the program. RunResources has no remaining steps. Why??
    _matches_python_within_1(MIN_SQRT_RATIO, IntegerTrait::<i32>::new(887272, true), 'MIN_SQRT_RATIO');
    ...
    _matches_python_within_1(91347285846066608454502609393939414163205914624, IntegerTrait::<i32>::new(831818, false), '913472...914624');

    _matches_python_within_1(MAX_SQRT_RATIO - 1, IntegerTrait::<i32>::new(887272, false), 'MAX_SQRT_RATIO - 1');
}
