...
fn test_tick_spacing_to_max_liquidity_per_tick_returns_correct_value_for_100_fee() {
    let mut state = STATE();
    assert(state.tick_storage.tick_spacing_to_max_liquidity_per_tick(2) == 383514844834609487117690504987493, 'Incorrect tick spacing for 100');
}

#[test]
fn test_tick_spacing_to_max_liquidity_per_tick_returns_correct_value_for_500_fee() {
    let mut state = STATE();
    assert(state.tick_storage.tick_spacing_to_max_liquidity_per_tick(10) == 1917569901783203986719870431555990, 'Incorrect tick spacing for 500');
}

#[test]
fn test_tick_spacing_to_max_liquidity_per_tick_returns_correct_value_for_3000_fee() {
    let mut state = STATE();
    assert(state.tick_storage.tick_spacing_to_max_liquidity_per_tick(60) == 11505743598341114571880798222544994, 'Incorrect tick spacing for 3000');
}

#[test]
fn test_tick_spacing_to_max_liquidity_per_tick_returns_correct_value_for_10000_fee() {
    let mut state = STATE();
    assert(state.tick_storage.tick_spacing_to_max_liquidity_per_tick(200) == 38350317471085141830651933667504588, 'Incorrect tick spacing for10000');
}

#[test]
fn test_tick_spacing_to_max_liquidity_per_tick_returns_correct_value_for_entire_range() {
    let mut state = STATE();
    assert(state.tick_storage.tick_spacing_to_max_liquidity_per_tick(887272) == BoundedInt::max() / 3, 'Incorrect tick spacing for max');
}

#[test]
fn test_tick_spacing_to_max_liquidity_per_tick_returns_correct_value_for_2302() {
    let mut state = STATE();
    assert(state.tick_storage.tick_spacing_to_max_liquidity_per_tick(2302) == 441351967472034323558203122479595605, 'Incorrect tick spacing for 2302');
}

#[test]
fn test_get_fee_growth_inside_returns_all_for_two_uninitialized_ticks_if_tick_is_inside() {
    let mut state = STATE();
    let (fee_growth_inside_0_X128, fee_growth_inside_1_X128) = state.tick_storage.get_fee_growth_inside(IntegerTrait::<i32>::new(2, true), IntegerTrait::<i32>::new(2, false), IntegerTrait::<i32>::new(0, false), 15, 15);
...
fn test_get_fee_growth_inside_returns_0_for_two_uninitialized_ticks_if_tick_is_above() {
    let mut state = STATE();
    let (fee_growth_inside_0_X128, fee_growth_inside_1_X128) = state.tick_storage.get_fee_growth_inside(IntegerTrait::<i32>::new(2, true), IntegerTrait::<i32>::new(2, false), IntegerTrait::<i32>::new(4, false), 15, 15);
...
fn test_get_fee_growth_inside_returns_0_for_two_uninitialized_ticks_if_tick_is_below() {
    let mut state = STATE();
    let (fee_growth_inside_0_X128, fee_growth_inside_1_X128) = state.tick_storage.get_fee_growth_inside(IntegerTrait::<i32>::new(2, true), IntegerTrait::<i32>::new(2, false), IntegerTrait::<i32>::new(4, true), 15, 15);
    assert(fee_growth_inside_0_X128 == 0, 'Incorrect fee 0');
    assert(fee_growth_inside_1_X128 == 0, 'Incorrect fee 1');
}
...
fn test_get_fee_growth_inside_substracts_upper_tick_if_below() {
    let mut state = STATE();
    let tick_info = TickInfo {liquidity_gross: 0, liquidity_net: IntegerTrait::<i128>::new(0, false), fee_growth_outside_0_X128: 2, fee_growth_outside_1_X128: 3};
...
fn test_get_fee_growth_inside_substracts_upper_and_lower_tick_if_inside() {
    ...
    let tick_info = TickInfo {liquidity_gross: 0, liquidity_net: IntegerTrait::<i128>::new(0, false), fee_growth_outside_0_X128: 2, fee_growth_outside_1_X128: 3};
    state.tick_storage.set_tick(IntegerTrait::<i32>::new(2, true), tick_info);
    let tick_info = TickInfo {liquidity_gross: 0, liquidity_net: IntegerTrait::<i128>::new(0, false), fee_growth_outside_0_X128: 4, fee_growth_outside_1_X128: 1};
    state.tick_storage.set_tick(IntegerTrait::<i32>::new(2, false), tick_info);
    let (fee_growth_inside_0_X128, fee_growth_inside_1_X128) = state.tick_storage.get_fee_growth_inside(IntegerTrait::<i32>::new(2, true), IntegerTrait::<i32>::new(2, false), IntegerTrait::<i32>::new(0, false), 15, 15);
...
fn test_get_fee_growth_inside_works_correctly_with_overflow_on_inside_tick() {
    let mut state = STATE();
    let tick_info = TickInfo {liquidity_gross: 0, liquidity_net: IntegerTrait::<i128>::new(0, false), fee_growth_outside_0_X128: BoundedInt::max() - 3, fee_growth_outside_1_X128: BoundedInt::max() - 2};
    state.tick_storage.set_tick(IntegerTrait::<i32>::new(2, true), tick_info);
    let tick_info = TickInfo {liquidity_gross: 0, liquidity_net: IntegerTrait::<i128>::new(0, false), fee_growth_outside_0_X128: 3, fee_growth_outside_1_X128: 5};
    state.tick_storage.set_tick(IntegerTrait::<i32>::new(2, false), tick_info);
    let (fee_growth_inside_0_X128, fee_growth_inside_1_X128) = state.tick_storage.get_fee_growth_inside(IntegerTrait::<i32>::new(2, true), IntegerTrait::<i32>::new(2, false), IntegerTrait::<i32>::new(0, false), 15, 15);
...
fn test_update_flips_from_zero_to_nonzero() {
    let mut state = STATE();
    let updated = state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, false, 3);
...
fn test_update_does_not_flip_from_nonzero_to_greater_nonzero() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, false, 3);
    let updated = state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, false, 3);
    assert(!updated, 'Incorrect updated');
}
...
fn test_update_flips_from_nonzero_to_zero() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, false, 3);
    let updated = state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, true), 0, 0, false, 3);
    assert(updated, 'Incorrect updated');
}
...
fn test_update_does_not_flip_from_nonzero_to_lesser_nonzero() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(2, false), 0, 0, false, 3);
    let updated = state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, true), 0, 0, false, 3);
    assert(!updated, 'Incorrect updated');
}
...
fn test_update_reverts_if_total_liquidity_gross_is_greater_than_max() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(2, false), 0, 0, false, 3);
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, true, 3);
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, false, 3);
}
...
fn test_update_nets_the_liquidity_based_on_upper_tick() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(2, false), 0, 0, false, 10);
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, true, 10);
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(3, false), 0, 0, true, 10);
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new(1, false), 0, 0, false, 10);
    ...
    assert(tick_info.liquidity_net == IntegerTrait::<i128>::new(2, false) + IntegerTrait::<i128>::new(1, true) + IntegerTrait::<i128>::new(3, true) + IntegerTrait::<i128>::new(1, false), 'Incorrect liquidity_net');
}
...
fn test_update_reverts_on_overflow_liquidity_gross() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new((BoundedInt::max() / 2) - 1, false), 0, 0, false, BoundedInt::max());
    state.tick_storage.update(IntegerTrait::<i32>::new(0, false), IntegerTrait::<i32>::new(0, false), IntegerTrait::<i128>::new((BoundedInt::max() / 2) - 1, false), 0, 0, false, BoundedInt::max());
}
...
fn test_update_assumes_all_growth_happens_below_ticks_lte_current_tick() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(1, false), IntegerTrait::<i32>::new(1, false), IntegerTrait::<i128>::new(1, false), 1, 2, false, BoundedInt::max());
...
fn test_update_does_not_set_any_growth_fields_if_tick_is_already_initialized() {
    let mut state = STATE();
    state.tick_storage.update(IntegerTrait::<i32>::new(1, false), IntegerTrait::<i32>::new(1, false), IntegerTrait::<i128>::new(1, false), 1, 2, false, BoundedInt::max());
    state.tick_storage.update(IntegerTrait::<i32>::new(1, false), IntegerTrait::<i32>::new(1, false), IntegerTrait::<i128>::new(1, false), 6, 7, false, BoundedInt::max());
    let tick_info = state.tick_storage.get_tick(IntegerTrait::<i32>::new(1, false));
    assert(tick_info.fee_growth_outside_0_X128 == 1, 'Incorrect fee 0');
    assert(tick_info.fee_growth_outside_1_X128 == 2, 'Incorrect fee 0');
}
...
fn test_clear_deletes_all_the_data_in_the_tick() {
    let mut state = STATE();
    let tick_info = TickInfo {liquidity_gross: 3, liquidity_net: IntegerTrait::<i128>::new(4, false), fee_growth_outside_0_X128: 1, fee_growth_outside_1_X128: 2};
    state.tick_storage.set_tick(IntegerTrait::<i32>::new(2, false), tick_info);
    ...
    assert(tick_info.liquidity_net == IntegerTrait::<i128>::new(0, false), 'Incorrect liquidity_net');
}
